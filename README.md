...
- 文章中心主导航采用左侧可展开知识库项目树；顶部文章导航只作为白底极简纵向文字快捷入口，不把 hover 多级下拉菜单作为 100 篇以上文章的主浏览方式。
- 文章中心左侧项目树坐标和宽度必须与单篇文章页左侧目录一致，右侧内容坐标和宽度必须与单篇文章页正文列一致；右侧使用当前系列标题区和横向文章卡片列表，不再放浅导航卡片。
...
- 文章中心左侧知识库索引只服务文章导航，不得混入资源页或产品页入口；索引标题样式与单篇文章目录标题保持一致，右侧系列标题必须与普通文章卡形成明显层级差异。
