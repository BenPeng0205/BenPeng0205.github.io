...
const translations = {
  zh: {
    ...
    "contact.cooperation.label": "OPC 合作 / 产品项目共创",
    "contact.cooperation.copy": "无论你对工业软件产品、自动化集成项目、标准化、工控Agent或是自媒体感兴趣，我们都可以聊一聊，先把问题、用户和交付边界聊清楚。",
  ...
  en: {
    ...
    "contact.cooperation.label": "OPC Collaboration / Product Co-creation",
    "contact.cooperation.copy": "Whether you are interested in industrial software products, automation integration, standardization, industrial-control agents, or technical media, let us talk through the problem, user, and delivery boundary first.",
