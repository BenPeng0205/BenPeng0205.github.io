...
const translations = {
  zh: {
    ...
    "contact.cooperation.copy": "正在做 OPC、工业软件或自动化产品项目？欢迎加微信联系我，先把问题、用户和交付边界聊清楚。",
    "contact.cooperation.cta": "加微信联系我",
  ...
  en: {
    ...
    "contact.cooperation.copy": "Working on an OPC, industrial-software, or automation product? Add me on WeChat to clarify the problem, user, and delivery boundary first.",
    "contact.cooperation.cta": "Contact via WeChat",
